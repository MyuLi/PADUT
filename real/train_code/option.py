...
parser.add_argument('--data_path_CAVE', default='/media/lmy/LMY/csi/cave_1024_28/', type=str,
                        help='path of data')
parser.add_argument('--data_path_KAIST', default='/data/HSI_Data/iccv_real/KAIST_CVPR2021/', type=str,
                    help='path of data')
parser.add_argument('--mask_path', default='/data/HSI_Data/iccv_real/TSA_real_data/mask.mat', type=str,
                    help='path of mask')
