...
parser.add_argument('--data_path', default='/data/HSI_Data/iccv_real/TSA_real_data/Measurements/', type=str,help='path of data')
parser.add_argument('--mask_path', default='/data/HSI_Data/iccv_real/TSA_real_data/mask.mat', type=str,help='path of mask')
